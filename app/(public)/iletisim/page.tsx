...
export default function IletisimPage() {
  const phone = process.env.NEXT_PUBLIC_PHONE || "0538 061 75 32";
  const email = process.env.NEXT_PUBLIC_EMAIL || "info@betasoft.com";
  const address = process.env.NEXT_PUBLIC_ADDRESS || "İkitelli OSB, Triko center sanayi sit. M1 Blok No:22 BAŞAKŞEHİR / İSTANBUL";
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col lg:flex-row min-h-[600px]">
          ...
          <div className="flex-1 p-8 md:p-16 flex flex-col justify-center">
            ...
            <div className="flex items-center gap-4 mt-12 pt-8 border-t border-zinc-100">
              <a href="#" className="w-10 h-10 rounded-full border border-zinc-200 flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-all">
